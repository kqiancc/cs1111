...
def tick():
    ...
    if start == True: 
        ...
        if shoot1 == True:
            ...
            player.color = "red" #WHY DOESNT THIS WORK
        ...
        if level2 == True:
            if enemy1Deaths >= 2 and enemy2Deaths >= 2:
                ...
                instructions1 = uvage.from_text(400, 450, "press w for weapon 1, a for weapon 2, and d for weapon 3", 30, "pink")
